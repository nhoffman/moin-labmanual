...
class FarmConfig(multiconfig.DefaultConfig):
    ...
    url_prefix_static = '/{{ SITE }}-static/htdocs'

    # all wikis in the farm share a common underlay
    data_underlay_dir = '{{ DATA_DIR }}/underlay/'

    # register the moinlm plugins
    plugin_dirs = [moinlm.plugin_dir]
